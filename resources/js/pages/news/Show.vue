        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full flex-grow space-y-8">
            ...
            <div class="space-y-4 max-w-4xl">
                ...
                <div class="pt-4 border-t border-slate-200/80 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <!-- Premium Brand Icon CTA Buttons -->
                    <div class="flex items-center gap-2">
                        <span class="text-xs font-bold text-slate-400 mr-1 hidden sm:inline">Bagikan:</span>
                        
                        <!-- WhatsApp -->
                        <button 
                            @click="shareToWA" 
                            class="w-10 h-10 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white flex items-center justify-center shadow-md hover:shadow-emerald-500/30 hover:scale-110 active:scale-95 transition-all cursor-pointer group"
                            title="Bagikan ke WhatsApp"
                        >
                            <svg class="w-5 h-5 fill-current text-white transition-transform group-hover:rotate-6" viewBox="0 0 24 24">
                        ...
                        <button 
                            @click="shareToFB" 
                            class="w-10 h-10 rounded-full bg-[#1877F2] hover:bg-[#166fe5] text-white flex items-center justify-center shadow-md hover:shadow-blue-500/30 hover:scale-110 active:scale-95 transition-all cursor-pointer group"
                        ...
                        <button 
                            @click="shareToIG" 
                            class="w-10 h-10 rounded-full bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center shadow-md hover:shadow-pink-500/30 hover:scale-110 active:scale-95 transition-all cursor-pointer group"
                        ...
                        <button 
                            ...
                            class="w-10 h-10 rounded-full bg-slate-800 hover:bg-slate-900 text-white flex items-center justify-center shadow-md hover:shadow-slate-500/30 hover:scale-110 active:scale-95 transition-all cursor-pointer group"
                            title="Salin Tautan Artikel"
                        >
                            <Check v-if="copied" class="w-5 h-5 text-emerald-400" />
                            <svg v-else class="w-5 h-5 text-white stroke-current fill-none stroke-2 transition-transform group-hover:rotate-6" viewBox="0 0 24 24">
