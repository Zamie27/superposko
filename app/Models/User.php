 ...
 */
#[Fillable(['name', 'email', 'password', 'google_id', 'university', 'npm', 'group_number', 'attendance_lat', 'attendance_lng', 'attendance_radius', 'cash_dues_start_date', 'kkn_address', 'posko_village', 'posko_district', 'posko_regency', 'posko_province', 'posko_postal_code', 'posko_logo_url', 'role', 'custom_role_id', 'host_id', 'subscription_expires_at', 'trial_ends_at', 'banned_at', 'verification_otp', 'verification_otp_expires_at', 'immich_api_key', 'immich_email', 'immich_password'])]
